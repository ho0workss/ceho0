window.STRATEGY = {
 ...
 "race": {
  ...
  "proxy": "실측 규칙(1일 1회, 한국 보고일 기준·전일 미국 종가 반영): 코어=S&P500 지수 일간 등락률, 성장 위성=검증 종가가 확보된 AI 대형주(NVDA·MSFT 우선) 동일가중 등락률, 방어 위성=KO(확보 시 SCHD 병용) 등락률, 파킹=+3.7%/252 고정. 슬리브 비중 45/30/15/10을 일간 수익률에 적용(일일 리밸런싱 근사 — 모형의 분기 리밸런싱과의 차이는 미미). 기준가는 날짜 명시 2소스 교차 확인 종가만 사용"
 }
};
