...
const PICKS = [
  ...
  // b41 — 2026-09-03 (기준가 9/2 종가). 반등일이지만 고용보고서 전야 + 인상 확률 70% + 교전 국면 지속: volX 유지.
  // MSFT 첫 편성(2소스 $501.02 완전 일치). XLE는 섹터 수치 상충으로 채점 보류 및 편성 제외.
  { id: 'b41-day-kofr',      s0: 112252, target: 112258, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-day-sgov',      s0: 100.43, target: 100.44, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-day-bil',       s0: 91.41,  target: 91.42,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-stk-day-dia',   s0: 530.06, target: 533.10, stop: 521.60, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-stk-day-ko',    s0: 88.00,  target: 88.58,  stop: 86.70,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-stk-day-msft',  s0: 501.02, target: 505.90, stop: 489.50, annVol: 0.24, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b41-week-sgov',     s0: 100.43, target: 100.47, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b41-week-kofr',     s0: 112252, target: 112287, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b41-stk-week-msft', s0: 501.02, target: 511.00, stop: 476.00, annVol: 0.24, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b41-month-sgov',    s0: 100.43, target: 100.56, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b41-month-bil',     s0: 91.41,  target: 91.53,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b41-stk-month-spy', s0: 764.47, target: 782.80, stop: 718.60, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  ...
  { id: 'b43-day-kofr',      s0: 112281, target: 112287, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-day-sgov',      s0: 100.45, target: 100.46, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-day-bil',       s0: 91.43,  target: 91.44,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-stk-day-dia',   s0: 533.56, target: 536.70, stop: 525.00, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-stk-day-nvda',  s0: 230.36, target: 234.60, stop: 220.40, annVol: 0.45, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-stk-day-ko',    s0: 88.07,  target: 88.65,  stop: 86.70,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b43-week-sgov',     s0: 100.45, target: 100.49, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b43-week-kofr',     s0: 112281, target: 112316, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b43-stk-week-dia',  s0: 533.56, target: 543.20, stop: 509.60, annVol: 0.14, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b43-month-sgov',    s0: 100.45, target: 100.58, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b43-month-bil',     s0: 91.43,  target: 91.55,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b43-stk-month-spy', s0: 769.62, target: 788.10, stop: 723.40, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b43-long-sgov',     s0: 100.45, target: 101.18, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b43-long-kofr',     s0: 112281, target: 112847, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b43-stk-long-dia',  s0: 533.56, target: 560.20, stop: 469.50, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },
  { id: 'b44-day-kofr',      s0: 112296, target: 112302, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b44-day-sgov',      s0: 100.47, target: 100.48, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b44-day-bil',       s0: 91.44,  target: 91.45,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b44-stk-day-dia',   s0: 527.26, target: 530.40, stop: 518.80, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b44-week-sgov',     s0: 100.47, target: 100.51, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b44-week-kofr',     s0: 112296, target: 112331, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b44-stk-week-dia',  s0: 527.26, target: 536.80, stop: 503.60, annVol: 0.14, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b44-month-sgov',    s0: 100.47, target: 100.60, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b44-month-bil',     s0: 91.44,  target: 91.56,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b44-stk-month-spy', s0: 765.13, target: 783.50, stop: 719.20, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  ...
  // b46 — 2026-09-11 (금, CPI 발표일 · 기준가: 목 9/10 종가 · DIA 당일 쿨다운, NVDA·KO·MSFT 당일 3종)
  { id: 'b46-day-kofr',      s0: 112310, target: 112316, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-day-sgov',      s0: 100.49, target: 100.50, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-day-bil',       s0: 91.46,  target: 91.47,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-stk-day-nvda',  s0: 218.36, target: 222.40, stop: 209.00, annVol: 0.45, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-stk-day-ko',    s0: 88.11,  target: 88.70,  stop: 86.80,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-stk-day-msft',  s0: 491.65, target: 496.45, stop: 480.30, annVol: 0.24, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b46-week-sgov',     s0: 100.49, target: 100.53, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b46-week-kofr',     s0: 112310, target: 112345, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b46-stk-week-ko',   s0: 88.11,  target: 89.95,  stop: 84.10,  annVol: 0.16, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b46-month-sgov',    s0: 100.49, target: 100.62, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b46-month-bil',     s0: 91.46,  target: 91.58,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b46-stk-month-spy', s0: 757.04, target: 775.20, stop: 711.60, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b46-long-sgov',     s0: 100.49, target: 101.22, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b46-long-kofr',     s0: 112310, target: 112876, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b46-stk-long-dia',  s0: 520.04, target: 546.10, stop: 457.60, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },
  // b47 — 2026-09-14 (월, FOMC 전야 · 기준가: 금 9/11 종가 · 당일 2종 KO·SCHD + 공석 1(MSFT 소스 상충, NVDA·DIA 쿨다운))
  { id: 'b47-day-kofr',      s0: 112316, target: 112322, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b47-day-sgov',      s0: 100.50, target: 100.51, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b47-day-bil',       s0: 91.47,  target: 91.48,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b47-stk-day-ko',    s0: 88.29,  target: 88.90,  stop: 87.00,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b47-stk-day-schd',  s0: 34.12,  target: 34.30,  stop: 33.60,  annVol: 0.13, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b47-week-sgov',     s0: 100.50, target: 100.54, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b47-week-kofr',     s0: 112316, target: 112351, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b47-stk-week-schd', s0: 34.12,  target: 34.55,  stop: 32.80,  annVol: 0.13, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b47-month-sgov',    s0: 100.50, target: 100.63, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b47-month-bil',     s0: 91.47,  target: 91.59,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b47-stk-month-spy', s0: 763.55, target: 781.90, stop: 717.70, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b47-long-sgov',     s0: 100.50, target: 101.23, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b47-long-kofr',     s0: 112316, target: 112882, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b47-stk-long-dia',  s0: 525.12, target: 551.40, stop: 462.10, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },
  // b48 — 2026-09-15 (화, FOMC 1일차 · 기준가: 월 9/14 종가 · 당일 2종 SCHD·XLE + 공석 1(KO 기준가 미확보·배당락, MSFT 미검증, NVDA·DIA 쿨다운))
  { id: 'b48-day-kofr',      s0: 112322, target: 112328, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b48-day-sgov',      s0: 100.51, target: 100.52, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b48-day-bil',       s0: 91.48,  target: 91.49,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b48-stk-day-schd',  s0: 34.39,  target: 34.57,  stop: 33.87,  annVol: 0.13, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b48-stk-day-xle',   s0: 65.83,  target: 66.58,  stop: 64.05,  annVol: 0.28, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b48-week-sgov',     s0: 100.51, target: 100.55, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b48-week-kofr',     s0: 112322, target: 112357, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b48-stk-week-xle',  s0: 65.83,  target: 67.50,  stop: 61.90,  annVol: 0.28, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b48-month-sgov',    s0: 100.51, target: 100.64, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b48-month-bil',     s0: 91.48,  target: 91.60,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b48-stk-month-spy', s0: 759.86, target: 778.10, stop: 714.30, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b48-long-sgov',     s0: 100.51, target: 101.24, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b48-long-kofr',     s0: 112322, target: 112888, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b48-stk-long-dia',  s0: 523.60, target: 549.80, stop: 460.80, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },
  // b49 — 2026-09-16 (수, FOMC 결정일 · 기준가: 화 9/15 종가 · 당일 SCHD 단독 + 공석 2(XLE·KO·NVDA·MSFT 시세 미확보/쿨다운))
  { id: 'b49-day-kofr',      s0: 112328, target: 112334, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b49-day-sgov',      s0: 100.52, target: 100.53, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b49-day-bil',       s0: 91.49,  target: 91.50,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b49-stk-day-schd',  s0: 34.33,  target: 34.51,  stop: 33.81,  annVol: 0.13, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b49-week-sgov',     s0: 100.52, target: 100.56, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b49-week-kofr',     s0: 112328, target: 112363, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b49-stk-week-schd', s0: 34.33,  target: 34.75,  stop: 33.00,  annVol: 0.13, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b49-month-sgov',    s0: 100.52, target: 100.65, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b49-month-bil',     s0: 91.49,  target: 91.61,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b49-stk-month-spy', s0: 756.44, target: 774.60, stop: 711.10, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b49-long-sgov',     s0: 100.52, target: 101.25, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b49-long-kofr',     s0: 112328, target: 112894, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b49-stk-long-dia',  s0: 520.32, target: 546.30, stop: 457.90, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },
  // b50 — 2026-09-17 (목, FOMC 인상 다음 날 · 기준가: 수 9/16 종가 · 당일 DIA 쿨다운 해제 단독 + 공석 2(개별 종목 수요일 종가 전부 미확보))
  { id: 'b50-day-kofr',      s0: 112334, target: 112340, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b50-day-sgov',      s0: 100.53, target: 100.54, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b50-day-bil',       s0: 91.50,  target: 91.51,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b50-stk-day-dia',   s0: 514.01, target: 516.90, stop: 505.80, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b50-week-sgov',     s0: 100.53, target: 100.57, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b50-week-kofr',     s0: 112334, target: 112369, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b50-stk-week-dia',  s0: 514.01, target: 523.40, stop: 490.90, annVol: 0.14, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b50-month-sgov',    s0: 100.53, target: 100.66, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b50-month-bil',     s0: 91.50,  target: 91.62,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b50-stk-month-spy', s0: 753.06, target: 771.10, stop: 707.90, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b50-long-sgov',     s0: 100.53, target: 101.26, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b50-long-kofr',     s0: 112334, target: 112900, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b50-stk-long-dia',  s0: 514.01, target: 539.70, stop: 452.30, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },

  // b51 — 2026-09-18 (금, 인상 소화 반등 다음 날 · 기준가: 목 9/17 종가 · 당일 3종 완전체 복귀(DIA·SCHD·KO) · 금요일 쿼드러플 위칭)
  { id: 'b51-day-kofr',      s0: 112340, target: 112346, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-day-sgov',      s0: 100.54, target: 100.55, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-day-bil',       s0: 91.51,  target: 91.52,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-stk-day-dia',   s0: 517.42, target: 520.30, stop: 509.10, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-stk-day-schd',  s0: 33.89,  target: 34.07,  stop: 33.38,  annVol: 0.13, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-stk-day-ko',    s0: 88.08,  target: 88.65,  stop: 86.80,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b51-week-sgov',     s0: 100.54, target: 100.58, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b51-week-kofr',     s0: 112340, target: 112375, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b51-stk-week-schd', s0: 33.89,  target: 34.30,  stop: 32.60,  annVol: 0.13, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b51-month-sgov',    s0: 100.54, target: 100.67, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b51-month-bil',     s0: 91.51,  target: 91.63,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b51-stk-month-spy', s0: 762.60, target: 780.90, stop: 716.80, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b51-long-sgov',     s0: 100.54, target: 101.27, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b51-long-kofr',     s0: 112340, target: 112906, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b51-stk-long-dia',  s0: 517.42, target: 543.30, stop: 455.30, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },

  // b52 — 2026-09-21 (월, 인상 주간 소화 후 첫 주 · 기준가: 금 9/18 종가 · NVDA 쿨다운 해제 복귀(DIA·KO·NVDA) · SCHD 종가 상충 제외)
  { id: 'b52-day-kofr',      s0: 112356, target: 112362, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-day-sgov',      s0: 100.56, target: 100.57, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-day-bil',       s0: 91.53,  target: 91.54,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-stk-day-dia',   s0: 516.21, target: 519.10, stop: 507.90, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-stk-day-ko',    s0: 88.25,  target: 88.85,  stop: 87.00,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-stk-day-nvda',  s0: 222.27, target: 226.40, stop: 212.70, annVol: 0.45, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b52-week-sgov',     s0: 100.56, target: 100.60, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b52-week-kofr',     s0: 112356, target: 112391, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b52-stk-week-ko',   s0: 88.25,  target: 90.10,  stop: 84.20,  annVol: 0.16, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b52-month-sgov',    s0: 100.56, target: 100.69, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b52-month-bil',     s0: 91.53,  target: 91.65,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b52-stk-month-spy', s0: 761.69, target: 780.00, stop: 716.00, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b52-long-sgov',     s0: 100.56, target: 101.29, stop: 98.8,   annVol: 0.0004, annDrift: 0.036, kind: 'long', model: 't' },
  { id: 'b52-long-kofr',     s0: 112356, target: 112922, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'long', model: 't' },
  { id: 'b52-stk-long-dia',  s0: 516.21, target: 542.00, stop: 454.30, annVol: 0.14, annDrift: 0.07, kind: 'long', model: 't' },

  // b53 — 2026-09-22 (화, AI 랠리·나스닥 신고가 다음 날 · 기준가: 월 9/21 종가 · 당일 DIA·NVDA + 공석 1(KO 상충·SCHD 단일·MSFT 월요일 미확보))
  { id: 'b53-day-kofr',      s0: 112362, target: 112368, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b53-day-sgov',      s0: 100.57, target: 100.58, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b53-day-bil',       s0: 91.54,  target: 91.55,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b53-stk-day-dia',   s0: 519.87, target: 522.80, stop: 511.50, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b53-stk-day-nvda',  s0: 227.38, target: 231.60, stop: 217.60, annVol: 0.45, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b53-week-sgov',     s0: 100.57, target: 100.61, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b53-week-kofr',     s0: 112362, target: 112397, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b53-stk-week-dia',  s0: 519.87, target: 529.40, stop: 496.50, annVol: 0.14, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b53-month-sgov',    s0: 100.57, target: 100.70, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b53-month-bil',     s0: 91.54,  target: 91.66,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b53-stk-month-spy', s0: 773.06, target: 791.60, stop: 726.70, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
  ...
  // b55 — 2026-09-24 (목, 금리 급등 리스크오프 급락 다음 날 · 기준가: 수 9/23 종가 · 당일 DIA 환산+KO 직접 + 공석 1(NVDA 상충·SCHD 미확보) · 1주 KO 복귀 · SPY 환산)
  { id: 'b55-day-kofr',      s0: 112374, target: 112380, stop: 111500, annVol: 0.0003, annDrift: 0.025, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b55-day-sgov',      s0: 100.59, target: 100.60, stop: 99.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b55-day-bil',       s0: 91.56,  target: 91.57,  stop: 90.7,   annVol: 0.0004, annDrift: 0.036, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b55-stk-day-dia',   s0: 514.50, target: 517.40, stop: 506.20, annVol: 0.14, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b55-stk-day-ko',    s0: 88.82,  target: 89.40,  stop: 87.55,  annVol: 0.16, annDrift: 0.0, kind: 'day', model: 't', volX: 1.3 },
  { id: 'b55-week-sgov',     s0: 100.59, target: 100.63, stop: 99.5,   annVol: 0.0004, annDrift: 0.036, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b55-week-kofr',     s0: 112374, target: 112409, stop: 111000, annVol: 0.0003, annDrift: 0.025, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b55-stk-week-ko',   s0: 88.82,  target: 90.70,  stop: 84.75,  annVol: 0.16, annDrift: 0.07, kind: 'week', model: 't', volX: 1.3 },
  { id: 'b55-month-sgov',    s0: 100.59, target: 100.72, stop: 99.3,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b55-month-bil',     s0: 91.56,  target: 91.68,  stop: 90.2,   annVol: 0.0004, annDrift: 0.036, kind: 'month', model: 't', volX: 1.2 },
  { id: 'b55-stk-month-spy', s0: 767.54, target: 786.00, stop: 721.50, annVol: 0.15, annDrift: 0.08, kind: 'month', model: 't', volX: 1.2 },
